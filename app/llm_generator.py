...
# Hardcode and use the 'aipipi' model only.
# This forces the client to use AI Pipe credentials and base URL.
AI_PIPE_BASE_URL = os.getenv("AI_PIPE_BASE_URL", "https://aipipe.org/openrouter/v1")
API_KEY = os.getenv("AI_PIPE_API_KEY")
MODEL = "openai/gpt-4.1-nano"
print("🤖 Using hardcoded model:", MODEL)

# Create client pointed at AI Pipe / OpenRouter endpoint
client = OpenAI(api_key=API_KEY, base_url=AI_PIPE_BASE_URL)
